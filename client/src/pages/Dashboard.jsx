...
const Dashboard = () => {
  ...
  const chartData = dashboardStats.revenueTrend.map((item) => ({
    date: `${months[item._id.month - 1]} ${item._id.day}, ${item._id.year}`,
    ...
    <div className="flex min-h-screen bg-[#fff8f2] font-inter">
      ...
      <main className="ml-[280px] flex-1 p-8">
        ...
        <div className="grid grid-cols-3 gap-6 mb-6">
          ...
          {/* CHART */}
          <div className="col-span-2 bg-white rounded-3xl border border-orange-300 p-6 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div>
                ...
                <p className="text-gray-500">
                  Daily earnings performance over the last 30 days
                </p>
              </div>

              <button className="border border-orange-200 px-4 py-2 rounded-xl">
                Last 30 Days
              </button>
            </div>

            <div className="w-full rounded-3xl bg-gradient-to-b from-orange-100 to-orange-50 p-4">
          ...
          {/* RECENT ACTIVITY */}
          <div className="bg-white rounded-3xl border border-orange-300 p-6 shadow-sm h-fit max-h-[720px] flex flex-col">
            ...
            {/* SCROLL AREA */}
            <div className="h-[410px] overflow-y-auto pr-2 space-y-4 custom-scrollbar">

                {dashboardStats.recentBookings.slice(0, 6).map((booking, index) => (

                <div
                    key={index}
                    className="border border-orange-100 rounded-2xl p-4 hover:bg-orange-50 transition-all"
                >
                    {/* TOP */}
